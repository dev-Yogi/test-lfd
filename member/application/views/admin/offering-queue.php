                ...
                <div class="col">
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-hover data-table data-table-offering-queue">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php foreach ($submissions as $submission) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo ucwords($submission->category) ?></td>
                                            <td>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <?php if ($submission->ose_submitted_offering_id): ?>
                                                    <a data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Omaha STEM Ecosystem Best Practices Assessment" href="<?php echo base_url("admin/offering/ose_assessment/{$submission->id}") ?>" class="btn btn-secondary btn-sm"><i class="fe fe-clipboard"></i> BPA</a>
                                                <?php else: ?>
                                                ...
                                                <?php if ($submission->status == 'approved'): ?>
                                                    <a href="<?php echo base_url("admin/offering/edit/{$submission->approved_offering_id}") ?>" class="btn btn-secondary btn-sm"><i class="fe fe-edit-2"></i> View Program</a>
                                                <?php else: ?>
                                                    <a href="<?php echo base_url("admin/offering/review/{$submission->id}") ?>" class="btn btn-secondary btn-sm"><i class="fe fe-eye"></i> Review</a>
                                                <?php endif ?>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
