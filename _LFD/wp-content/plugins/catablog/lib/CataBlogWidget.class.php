...
class CataBlogWidget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('CataBlogWidget', __("CataBlog Catalog", "catablog"), $widget_ops);
	}
...
class CataBlogCategoryWidget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('CataBlogCategoryWidget', __("CataBlog Categories", "catablog"), $widget_ops);
	}
