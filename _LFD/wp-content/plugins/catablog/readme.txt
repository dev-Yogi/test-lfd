...
= 1.7.0 =
* New: Replace Multiple Image Flash Uploader with a new HTML5 Uploader.
* Fix: Fatal error with newer versions of wp_unique_term_slug().
* Fix: Non-fatal errors and deprecation warnings.
