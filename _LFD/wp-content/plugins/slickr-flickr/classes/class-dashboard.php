...
class Slickr_Flickr_Dashboard extends Slickr_Flickr_Admin {
	private $tips = array(
			...
			'flickr_galleria_theme' => array('heading' => 'Theme/Skin', 'tip' => 'Available themes are azur, classic, folio, fullscreen, miniml and twelve. Only enter a different value if you have purchased a premium Galleria theme or written one and located it under the themes folder specified below.'),
...
LINKS_PANEL;
 	...
 	function intro_panel($post,$metabox){	
		...
		print <<< INTRO_PANEL
	<p>For information on Slickr Flickr visit the <a href="{$home}">Slickr Flickr Plugin Home Page</a>.</p>
	<p>For support go to  <a href="{$help}">Slickr Flickr Pro Members Support page</a></p>
