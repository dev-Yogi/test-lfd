...
<head>
	...
	<title><?php echo $heading ?? 'Error' ?> | AIM Participant Portal</title>
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="card" action="" method="post">
                        <div class="card-body p-6 text-center">
                            ...
                            <h1 class="my-5"><?php echo $heading ?></h1>
                            <div class="">
                                <p><?php echo $message ?></p>
                                <a href="<?php echo base_url() ?>" class="btn btn-primary btn-lg my-5">Back to AIM Participant Portal</a>
                            </div>
                        </div>
                    </div>
                </div>
