	...
	<div class="page-main">
		<div class="container">
			<div class="page-header">
				<h1 class="page-title">
					Courses <span class="text-muted small"><span class="p-2">&middot;</span> My Courses</span>
				</h1>
			</div>
				...
				<div class="col">
					...
					<div class="card">
						<div class="card-header">
							<h3 class="card-title mr-auto">My Courses</h3>
							<div class="pr-0">
							...
							<table class="table card-table table-vcenter table-hover data-table data-table-courses">
								...
								<tbody>
									...
									<?php if (empty($courses)): ?>
										<tr>
											<td colspan="6">You do not have any courses - <a href="<?php echo base_url("admin/course/create") ?>">Start a New Course</a></td>
										</tr>
									<?php endif ?>
								</tbody>
							</table>
