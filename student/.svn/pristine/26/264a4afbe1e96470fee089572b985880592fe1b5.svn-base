                        ...
                        <div class="card p-5 mb-3">
                            ...
                            <div class="row">
                                <div class="col mt-5">
                                    ...
                                    <a href="<?php echo base_url("admin/category/") ?>" class="btn btn-secondary ml-2">Cancel</a>
                                </div>
                            </div>
                        </div>

                        <?php if (!empty($category)): ?>
                            <a href="<?php echo base_url("admin/category/remove/{$category->id}") ?>" onclick="return confirm('Are you sure you want to remove this category?')" class="btn btn-link float-right mr-3"><i class="fe fe-trash"></i> Remove Category</a>
                        <?php endif ?>
                    </form>
                </div>
            </div>
