	...
	<div class="page-main">
		<div class="container">
			<div class="page-header">
				<h1 class="page-title">
					Reports <span class="text-muted small"><span class="p-2">&middot;</span> Instructors</span>
				</h1>
			</div>
			<div class="row">
				<div class="col-xl-6">
				...
				<div class="col-12">
					<div class="card">
						...
						<div class="table-responsive">
							<table class="table card-table table-vcenter table-hover data-table-report-instructors">
								<thead>
									<tr>
										<th>ID</th>
										<th>Name</th>
								...
								<tbody>
									<?php foreach ($instructors as $instructor): ?>
										<tr>
											...
											<td><?php echo $instructor->count_courses ?? '<span class="text-muted">0</span>' ?></td>
